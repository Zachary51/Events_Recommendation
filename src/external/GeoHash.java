...
/**
 * TicketMaster asked to use GeoPoint instead of latitude and longitude directly
 * in request, this helper class is for GeoHash encoding
 * 
 * @author zacharywong From:
